        ...
        <div class="card rounded-0">
          <div class="card-body text-center">
            ...
            if (isset($_GET['loginerror'])) {
              ...
              echo "<a href='" . routeUrl('/login') . "' class='btn btn-secondary btn-sm rounded-0 px-3'>ok</a>";
            }

            if (isset($_GET['signuperror'])) {
              echo "<p>" . htmlspecialchars($_GET['signuperror'], ENT_QUOTES, 'UTF-8') . "</p>";
              echo "<a href='" . routeUrl('/signup') . "' class='btn btn-secondary btn-sm rounded-0 px-3'>ok</a>";
            }
