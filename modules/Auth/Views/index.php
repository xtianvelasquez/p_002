  ...
  <nav class="navbar navbar-expand-md py-3 px-3">
    ...
    <div class="collapse navbar-collapse" id="ourDashboard">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" href="<?= routeUrl('/login') ?>">login</a>
        </li>
        <li class="nav-item">
  ...
  <section id="about-us">
    <div class="container-xl mt-3 mb-5">
      <div class="row justify-content-center align-items-center">
        <img src="<?= assetUrl('images/logo.png') ?>" alt="more than blulendar logo" class="img-fluid d-md-none d-block">
        ...
        <div class="col-md-5">
          <img src="<?= assetUrl('images/logo.png') ?>" alt="more than blulendar logo" class="img-fluid d-md-block d-none">
        </div>
      </div>
    </div>
  </section>
