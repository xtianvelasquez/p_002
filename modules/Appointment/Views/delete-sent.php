  ...
  <nav class="navbar navbar-expand-md py-3 px-3">
    ...
    <div class="collapse navbar-collapse" id="ourDashboard">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="<?= routeUrl('/sent') ?>">sent</a>
        </li>
        <li class="nav-item">
      ...
      <div class="col-10 col-md-8">
        <div class="card rounded-0">
          <div class="card-body text-center">
            ...
            <a href='<?= routeUrl("/appointment/delete-sent/confirm?yes=" . $appointmentId) ?>' class='btn btn-secondary btn-sm rounded-0 px-3'>Yes</a>
            <a href='<?= routeUrl("/sent") ?>' class='btn btn-secondary btn-sm rounded-0 px-3 m-1'>No</a>
          </div>
        </div>
      </div>
    </div>
