      ...
      <div class="col-10 col-md-8">
        <div class="card rounded-0">
          <div class="card-body text-center">
            ...
            <a href='<?= routeUrl("/appointment/delete/confirm?yes=" . $appointmentId) ?>' class='btn btn-secondary btn-sm rounded-0 px-3'>Yes</a>
            <a href='<?= routeUrl("/received") ?>' class='btn btn-secondary btn-sm rounded-0 px-3 m-1'>No</a>
          </div>
        </div>
      </div>
    </div>
