        ...
        <div class="card rounded-0">
          <div class="card-body text-center">
            ...
            if (isset($_GET["id"])) {
              ...
              echo "<a href='db-delete-sent.php?yes={$appointmentId}' class='btn btn-secondary btn-sm rounded-0 px-3'>Yes</a>";
              echo "<a href='user-sent.php' class='btn btn-secondary btn-sm rounded-0 px-3 m-1'>No</a>";
            }
            ?>
          </div>
        </div>
