        ...
        <div class="card rounded-0">
          <div class="card-body text-center">
            ...
            if (isset($_GET["id"])) {
              ...
              echo "<a href='db-edit.php?approved={$appointmentId}' class='btn btn-secondary btn-sm rounded-0 px-3 m-1'>approved</a>";
              echo "<a href='db-edit.php?denied={$appointmentId}' class='btn btn-secondary btn-sm rounded-0 px-3'>denied</a>";
              echo "<a href='db-edit.php?cancel={$appointmentId}' class='btn btn-secondary btn-sm rounded-0 px-3 m-1'>cancel</a>";
              echo "<a href='user-panel.php' class='btn btn-secondary btn-sm rounded-0 px-3'>back</a>";
            }
            ?>
          </div>
        </div>
